...
class RetinaTrackNet(nn.Module):
    ...
    def __init__(self, cfg=None, phase='train'):
        ...
        if cfg['name'] == 'Resnet50':
            ...
            self.body = _utils.IntermediateLayerGetter(backbone, cfg['ShuffleNetG2_return_layers'])
            pass
        elif cfg['name'] == 'ShuffleNetV2':
            backbone = ShuffleNetV2(cfg['ShuffleNetV2'])
            self.body = _utils.IntermediateLayerGetter(backbone, cfg['ShuffleNetV2_return_layers'])
            ch_list=[24,58,88,122]
            cfg['in_channel']= ch_list[int(cfg['ShuffleNetV2']['width_mult']*2-1)]
            pass
