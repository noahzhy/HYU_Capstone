...
parser.add_argument('--trained_model', default='weights/epoch_20_loss_0.8120322823524475.pth',
...
parser.add_argument('--vis_thres', default=0.02, type=float,
                    help='visualization_threshold')
parser.add_argument('--image', default='images/000360.jpg',
